    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="mb-8 flex justify-between items-center">
          <div>
            <Link href="/" className="text-esmeralda-600 hover:text-esmeralda-700 dark:text-esmeralda-400 dark:hover:text-esmeralda-300 text-sm mb-2 inline-block">
              ← Volver al inicio
            </Link>
            <h1 className="text-3xl font-bold mb-2 text-gray-900 dark:text-white">Todos los Listados</h1>
            <p className="text-gray-600 dark:text-gray-400">Explora todos los listados disponibles en la plataforma</p>
          </div>
          <Link
            href="/listings/new"
